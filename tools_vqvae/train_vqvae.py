...
from dataset_vqvae.mnist_dataset import MnistDataset
...
def train_for_one_epoch(epoch_idx, model, mnist_loader, optimizer, criterion, config):
    r"""
...
def train(args):
    ...
    # Create the dataset, define the training parameter and instantiate the model
    model = get_model(config).to(device)
    mnist = MnistDataset(split='train', im_path=config['train_params']['train_path'], im_ext='png',
